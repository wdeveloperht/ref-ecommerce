...
$(() => {
    document.addEventListener('core-table-init-completed', function (event) {
        new GalleryAdminManagement().init(event.detail.table.prop('id'))
    })

    $(document)
        .on('show.bs.modal', '#gallery-item-modal', (e) => {
        ...
        .on('click', '#gallery-item-modal button[type="submit"]', (e) => {
            e.preventDefault()
