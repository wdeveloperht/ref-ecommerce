...
return [
    ...
    'webhook_setup_guide' => [
        'title' => 'InecoBank Webhook Setup Guide',
        'description' => 'Follow these steps to set up a InecoBank webhook',
        'step_1_label' => 'Login to the InecoBank Dashboard',
        ...
        'step_4_description' => 'Copy the "Signing Secret" value from the "Webhook Details" section and paste it into the "InecoBank Webhook Secret" field in the "InecoBank" section of the "Payment" tab in the "Settings" page.',
    ],
];
